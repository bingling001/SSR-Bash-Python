...
cd /usr/local
git clone https://github.com/koolshare/shadowsocksr.git
git clone https://github.com/bingling001/SSR-Bash-Python.git
...
wget https://github.com/jedisct1/libsodium/releases/download/1.0.10/libsodium-1.0.10$LIBSODIUM_VER.tar.gz
